...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Candace.Ward7',
      password: 'sQSdHqZX5uDKg3H',
      email: 'Maiya_Konopelski@hotmail.com',
      name: 'Vickie Vandervort',
      userType: 723,
      mobileNo: '1-440-459-3864 x12756',
      resetPasswordLink: {},
      loginRetryLimit: 692,
      loginReactiveTime: '2022-11-18T22:37:13.256Z',
      id: '6246d0b5a06e3b0941b1e215'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Camylle_Hegmann38',
        'password':'8K9_ZYOeNwLAhYI',
        'email':'Wilhelm_Towne@hotmail.com',
        'name':'Daryl Lueilwitz',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(378) 513-5168',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Wilhelm_Towne@hotmail.com', });
